      ...
      <div className="mx-auto max-w-6xl px-4 text-slate-100">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-white/10 bg-white/5 p-8">
            ...
            <p className="mt-6 text-sm text-orange-200">Escrow fee: 1% of deposit (split with landlord)</p>
          </div>
          ...
          <div className="rounded-3xl border border-orange-400/40 bg-orange-500/15 p-8">
            ...
            <p className="mt-6 text-sm text-orange-100">Plans from $25/mo (single unit) to $100/mo (portfolio)</p>
