        ...
        <>
          ...
          >
            <div className="mx-auto max-w-7xl px-4 py-3 flex items-center justify-between">
              ...
              <button className="bg-teal-500 hover:bg-teal-600 active:bg-teal-700 text-white font-semibold px-6 py-2 rounded-lg transition-colors flex items-center gap-2 shadow-lg shadow-teal-500/20">
                Start Free Unit
          ...
          >
            <button className="w-full bg-teal-500 hover:bg-teal-600 active:bg-teal-700 text-white font-semibold px-6 py-4 rounded-xl transition-colors flex items-center justify-center gap-2 shadow-2xl shadow-teal-500/30 touch-manipulation">
              Start Free Unit
