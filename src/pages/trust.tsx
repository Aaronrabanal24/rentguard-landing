    ...
    <PageContainer title="Fairvia — Trust & Security">
      <section className="bg-white py-10 text-slate-900">
        <div className="mx-auto max-w-5xl px-4 text-center">
          ...
          <h1 className="mt-4 text-3xl font-semibold sm:text-4xl">Escrow protection and documentation built for landlord confidence</h1>
          <p className="mt-3 text-sm text-slate-600 sm:text-base">
            Fairvia partners with licensed escrow providers, keeps audit trails intact, and protects renter data so you can operate transparently.
          </p>
        </div>
      </section>
      <TrustSignals />
